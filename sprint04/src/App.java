...
public class App {
	...
	public static void main(String[] args) {
		...
		String nomeRobo[] = new String[nEquipes];
		...
		System.out.println("\nNome das Equipes: ");
		System.out.println("1) Desejo Inserir Nomes Manualmente\n2) Desejo que a máquine nomeie as Equipes;");
		opcaoNomes = sc.nextInt();
		sc.nextLine();

		if (opcaoNomes == 1) {
			for (int i = 0; i < nomeRobo.length; i++) {
				System.out.println("\nDigite o nome da equipe " + (i + 1) + ": ");
				nomeRobo[i] = sc.nextLine();
			}
		} else if (opcaoNomes == 2) {
			System.out.println("\nIDS serão gerados de 1 a " + nEquipes);
		} else {
			System.out.println("\nOpção Inválida");
			System.out.println("IDS serão gerados de 1 a " + nEquipes);
		}
		...
		System.out.println("\nComo Deseja assistir a primeira rodada ?");
			...
			for (int i = 0; i < pontos.length; i++) {
				for (int j = (i + 1); j < pontos[i].length + 1; j++) {
					...
					if (idEquipe[i] != idEquipe[j]) {
						...
						if (opcaoNomes == 1) {
							System.out.println("  " + nomeRobo[i] + " x " + nomeRobo[j]);
						} else {
						...
						if (pontos[i][j - 1] == pontos[j][i]) {
							...
							if (opcaoNomes == 1) {
								System.out.println("    " + nomeRobo[i] + " = " + notaDesign[i]);
								System.out.println("    " + nomeRobo[j] + " = " + notaDesign[j]);
							} else {
							...
							if (notaDesign[i] > notaDesign[j]) {
								if (opcaoNomes == 1) {
									System.out.println("    " + nomeRobo[i] + " venceu!");
								} else {
								...
								if (opcaoNomes == 1) {
									System.out.println("    " + nomeRobo[j] + " venceu!");
								} else {
		...
		case 2: {
			...
			for (int i = 0; i < vitorias.length; i++) {
				if (opcaoNomes == 1) {
					System.out.print(
							"Equipe " + nomeRobo[i] + ": " + vitorias[i] + " vitórias, " + derrotas[i] + " derrotas");
				} else {
					System.out.print(
							"Equipe " + (i + 1) + ": " + vitorias[i] + " vitórias, " + derrotas[i] + " derrotas");
		...
		if (totalPontos[0] == totalPontos[1]) {
			if (opcaoNomes == 1) {
				System.out.println("1) Equipe " + nomeRobo[0] + ": " + totalPontos[0] + " Pontos --> Nota de Design: "
						+ notaDesign[0]);
				System.out.println("2) Equipe " + nomeRobo[1] + ": " + totalPontos[1] + " Pontos --> Nota de Design: "
						+ notaDesign[1]);
				System.out.println("3) Equipe " + nomeRobo[2] + ": " + totalPontos[2] + " Pontos");
			} else {
			...
			if (opcaoNomes == 1) {
				System.out.println("1) Equipe " + nomeRobo[0] + ": " + totalPontos[0] + " Pontos");
				System.out.println("2) Equipe " + nomeRobo[1] + ": " + totalPontos[1] + " Pontos --> Nota de Design: "
						+ notaDesign[1]);
				System.out.println("3) Equipe " + nomeRobo[2] + ": " + totalPontos[2] + " Pontos --> Nota de Design: "
						+ notaDesign[2]);
			} else {
		...
		} if (totalPontos[1] != totalPontos[2] && totalPontos[0] != totalPontos[1]) {
			if (opcaoNomes == 1) {
				System.out.println("1) Equipe " + nomeRobo[0] + ": " + totalPontos[0] + " Pontos");
				System.out.println("2) Equipe " + nomeRobo[1] + ": " + totalPontos[1] + " Pontos");
				System.out.println("3) Equipe " + nomeRobo[2] + ": " + totalPontos[2] + " Pontos");
			} else {
				System.out.println("1) Equipe " + idEquipe[0] + ": " + totalPontos[0] + " Pontos");
		...
		for (int i = 0; i < pontosFINAL.length; i++) {
			totalPontosFase1[i]=totalPontos[i];
		}
		// zerando arrays
		for (int i = 0; i < nEquipes; i++) {
			vitorias[i] = 0;
		...
		case 2:
			...
			for (int i = 0; i < 3; i++) {
				if (opcaoNomes == 1) {
					System.out.print("Equipe " + nomeRobo[i] + ": " + vitorias[i] + " vitórias, " + derrotas[i] + " derrotas");
				}else {
		...
		for (int i = 0; i < 1; i++) {
			...
			if (opcaoNomes == 1) {
				System.out.println("Equipe " + nomeRobo[i] + " com " + (totalPontos[i] + totalPontosFase1[i]) + " pontos ("
						+ totalPontosFase1[i] + " pontos na primeira rodada, " + totalPontos[i] + " na segunda rodada)");
			}else {
				System.out.println("Equipe " + idEquipe[i] + " com " + (totalPontos[i] + totalPontosFase1[i]) + " pontos ("
						+ totalPontosFase1[i] + " pontos na primeira rodada, " + totalPontos[i] + " na segunda rodada)");
